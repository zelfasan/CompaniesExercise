namespace Companies.API.Extensions
{
    public static class HttpExtensions
    {
        ...
        public static async Task<IResult> HttpDeleteAsync<TEntity, TDto>(this IDbService db, int id) where TEntity : class, IEntity
        {
            try
            {
        ...
        public static async Task<IResult> HttpAddAsync<TEntity, TDto>(this IDbService db, TDto dto) where TEntity : class where TDto : class
        {
            try
            {
                var entity = await db.AddAsync<TEntity, TDto>(dto);
        ...
        public static async Task<IResult> HttpDeleteAsync<TReferenceEntity, TDto>
            (this IDbService db, TDto dto) where TReferenceEntity : class, IReferenceEntity where TDto : class
        {
            try
            {
