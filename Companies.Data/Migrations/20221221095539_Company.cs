        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "name1", "last1", 10000, true },
                    { 2, 2, "name2", "last2", 20000, false },
                    { 3, 2, "name3", "last3", 30000, false },
                    { 4, 3, "name4", "last4", 40000, true }
                });
